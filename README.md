...
Os requisitos de aprendizagem foram elaborados com base em verbos cognitivos associados à taxonomia de Bloom aplicada à Computação, contemplando conceitos, habilidades e disposições.
...
O objeto de aprendizagem dialoga com a BNCC de Computação, especialmente com habilidades relacionadas aos eixos Mundo Digital e Cultura Digital. Entre as habilidades mais diretamente associadas, destacam-se:
